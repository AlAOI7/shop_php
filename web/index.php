<?php require "include/head.php" ; ?>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>احصل على شقة
							<span>10%</span> استرداد النقود</p>
						<a class="button2" href="product.php">تسوق الآن</a>
					</div>
				</div>
			</div>
			...
			<div class="item item3">
				<div class="container">
					<div class="carousel-caption">
						...
						<p>احصل على أفضل عرض حتى
							<span>20%</span>
						</p>
						<a class="button2" href="product.php">تسوق الان </a>
					</div>
				</div>
			</div>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">أفضل منتجاتنا
				...
				<div class="wrapper">
								...
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.php" class="link-product-add-cart">عرض سريع</a>
										</div>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<span class="product-new-top">التالي</span>
					...
					<div class="product-sec1 product-sec2">
						<div class="col-xs-7 effect-bg">
							<h3 class="">الطاقة النقية</h3>
							<h6>استمتع بجميع منتجاتنا الصحية</h6>
							<p>Get Extra 10% Off</p>
						</div>
						<h3 class="w3l-nut-middle">المكسرات والفواكه الجافة</h3>
					...
					<!-- third section (oils) -->
					<div class="product-sec1">
						<h3 class="heading-tittle">زيوت</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">المعكرونة والمعكرونة</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">

           ...
           <div class="row">
              ...
              ?>
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-3 text-right control-label col-form-label">الاعانات الفرعية1</label>
                                        <div class="col-sm-9">
                                            <input name="name" type="text" class="form-control" id="name" value="<?= $prorow['name'] ;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="stock" type="text" class="form-control" id="stock" value="<?= $prorow['stock'] ;?>">
                                        </div>
                                    </div>
